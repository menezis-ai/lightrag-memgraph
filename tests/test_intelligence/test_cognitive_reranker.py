...
from twindb_lightrag_memgraph.intelligence.features.cognitive_reranker import CognitiveReranker
...
class TestCognitiveReranker:
    ...
    async def test_rerank_fallback_on_strict_filter(self, reranker, sample_chunks, mock_openai_client):
