...
class TestReasoningEngine:
    ...
    async def test_analyze_basic_question(self, engine, mock_openai_client, reasoning_result_json):
        client = mock_openai_client(reasoning_result_json)
        with patch("twindb_lightrag_memgraph.intelligence.react.reason.AsyncOpenAI", return_value=client):
    ...
    async def test_analyze_with_coreference(self, engine, mock_openai_client, reasoning_coref_json):
        history = [
    ...
    async def test_analyze_no_history(self, engine, mock_openai_client, reasoning_result_json):
        client = mock_openai_client(reasoning_result_json)
        with patch("twindb_lightrag_memgraph.intelligence.react.reason.AsyncOpenAI", return_value=client):
    ...
    async def test_analyze_long_history_truncated(self, engine, mock_openai_client, reasoning_result_json):
