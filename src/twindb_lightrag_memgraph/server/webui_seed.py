...
DEMO_STEWARD = "demo.steward"
DEMO_REVIEWER = "demo.reviewer"
DEMO_ARCHITECT = "demo.architect"
...
DOCUMENTS: list[dict[str, Any]] = [
    {
        ...
        "summary": "Step-by-step guide for restarting Oracle DB on RHEL 9 in a demo environment",
        "tags": ["rman", "oracle"],
    ...
    },
    {
        "id": "d2",
        "type": "confluence",
        "source": "/demo/runbooks/oracle-pga-tuning",
    ...
    },
    {
        "id": "d5",
        "type": "confluence",
        "source": "/demo/incidents/2026-04-prod-outage",
...
NOTIFICATIONS: list[dict[str, Any]] = [
    {
        ...
        "tagname": "rman",
        "suffix": "applied",
        "sub": f"{ORACLE_RESTART_SOURCE} · 418 chunks",
        "rel": "12m ago",
        "read": False,
    },
    {
    ...
    },
    {
        ...
        "kind": "source-ready",
        "title": "Source ready",
        "sub": f"{MEMGRAPH_MAGE_SOURCE} · 42 chunks",
        "rel": REL_25M_AGO,
        "read": False,
    },
    {
...
THESAURUS: list[dict[str, Any]] = [
    {
        "tag": "rman",
        "category": "oracle",
        "def": "Recovery Manager — Oracle backup and recovery tool",
    },
    {
        "tag": "rmf-validated",
        "category": "governance",
        "def": "Reviewed by risk management framework",
    },
    {
        "tag": "oracle",
        "category": "oracle",
        "def": "Oracle Database engine and ecosystem",
    },
    {
        "tag": "production",
        "category": "lifecycle",
        "def": "Document applies to production environments",
    },
    {
        "tag": "incident",
        "category": "lifecycle",
        "def": "Postmortem or active incident material",
    },
    {"tag": "vmware", "category": "infra", "def": "VMware vSphere and ESXi runtime"},
    {
        "tag": "memgraph",
        "category": "infra",
        "def": "Memgraph graph database (MAGE extensions)",
    },
    {
        "tag": "network",
        "category": "network",
        "def": "Networking, routing, firewall topics",
    },
    {
        "tag": "cft",
        "category": "network",
        "def": "Cross-platform file transfer (Axway CFT)",
    },
    {"tag": "swift", "category": "messaging", "def": "SWIFT messaging flows"},
    {
        "tag": "governance",
        "category": "governance",
        "def": "Internal governance, audit, or charter",
    },
    {
        "tag": "deprecated",
        "category": "lifecycle",
        "def": "Marked for archival, do not act on",
    },
    {
        "tag": "pending-review",
        "category": "lifecycle",
        "def": "Awaiting risk review before publish",
    },
]
...
TAGS: list[dict[str, Any]] = [
    _tag(
        ...
        chunks_count=1842,
        query_freq_30d=312,
        created={"by": DEMO_STEWARD, "at": "2025-09-12"},
        last_edit={
            "by": DEMO_STEWARD,
            "at": "2026-05-11",
            "action": "promoted to Tier 1",
        },
        related=[
        ...
        examples=[ORACLE_RESTART_SOURCE, "/demo/runbooks/rman-restore-cookbook"],
    ),
    _tag(
        "oracle",
        1,
        ...
        examples=[ORACLE_RESTART_SOURCE, "/demo/runbooks/oracle-pga-tuning"],
    ),
    _tag(
        "vmware",
        1,
    ...
    _tag(
        ...
        chunks_count=142,
        query_freq_30d=41,
        created={"by": DEMO_REVIEWER, "at": "2025-11-04"},
        last_edit={
            "by": DEMO_REVIEWER,
            "at": "2026-02-10",
            "action": "added alias mage",
        },
    ...
    _tag(
        ...
        chunks_count=287,
        query_freq_30d=22,
        created={"by": DEMO_REVIEWER, "at": "2026-01-22"},
        last_edit={
            "by": DEMO_STEWARD,
            "at": "2026-04-15",
            "action": "approved for Tier 2",
        },
        related=[
    ...
    _tag(
        ...
        chunks_count=218,
        query_freq_30d=12,
        created={"by": DEMO_ARCHITECT, "at": "2025-12-05"},
        last_edit={"by": DEMO_ARCHITECT, "at": "2025-12-05", "action": "created"},
        related=[
    ...
    _tag(
        ...
        chunks_count=88,
        query_freq_30d=17,
        created={"by": DEMO_STEWARD, "at": "2026-05-10"},
        last_edit={
            "by": DEMO_STEWARD,
            "at": "2026-05-10",
            "action": "created as Tier 2",
        },
    ...
    _tag(
        ...
        chunks_count=62,
        query_freq_30d=1,
        created={"by": DEMO_STEWARD, "at": "2025-10-18"},
        last_edit={"by": DEMO_STEWARD, "at": "2025-10-18", "action": "created"},
    ...
    _tag(
        ...
        chunks_count=88,
        query_freq_30d=2,
        created={"by": DEMO_STEWARD, "at": "2025-10-01"},
        last_edit={"by": DEMO_STEWARD, "at": "2025-10-01", "action": "created"},
    ...
    _tag(
        ...
        chunks_count=96,
        query_freq_30d=28,
        created={"by": DEMO_REVIEWER, "at": "2026-02-14"},
        last_edit={
            "by": DEMO_REVIEWER,
            "at": "2026-05-02",
    ...
    _tag(
        ...
        chunks_count=154,
        query_freq_30d=18,
        created={"by": DEMO_REVIEWER, "at": "2026-03-20"},
        last_edit={
            "by": DEMO_REVIEWER,
            "at": "2026-03-20",
            "action": "created as Tier 2",
    ...
    _tag(
        ...
        chunks_count=38,
        query_freq_30d=4,
        created={"by": DEMO_OPERATOR, "at": "2026-04-29"},
        last_edit={
            "by": DEMO_OPERATOR,
            "at": "2026-04-29",
            "action": "created as Tier 3",
        },
    ),
    _tag(
        "ansible",
        ...
        chunks_count=71,
        query_freq_30d=7,
        created={"by": DEMO_OPERATOR, "at": "2026-04-12"},
        last_edit={
            "by": DEMO_OPERATOR,
            "at": "2026-04-12",
            "action": "created as Tier 3",
    ...
    _tag(
        ...
        created={"by": DEMO_OPERATOR, "at": "2026-05-09"},
        last_edit={"by": DEMO_OPERATOR, "at": "2026-05-09", "action": "requested"},
    ...
    _tag(
        ...
        created={"by": DEMO_ARCHITECT, "at": "2026-05-10"},
        last_edit={"by": DEMO_ARCHITECT, "at": "2026-05-10", "action": "requested"},
        related=[{"tag": "iso20022", "strength": 0.85}],
        requested_by=DEMO_ARCHITECT,
...
ACTIVITY: list[dict[str, Any]] = [
    _evt(
        ...
        "DBA",
        "query",
        "How to restart Oracle on RHEL 9?",
    ...
    _evt(
        ...
        "Ingestion rejected — unsupported MIME type & 312 MB > 50 MB limit",
        {
            ...
            "size_bytes": 326962482,
            "error_code": "E_UNSUPPORTED_FORMAT",
        },
    ),
    _evt(
        "evt_01HX9Z7B",
        "2026-05-11T09:11:33Z",
        "44m ago",
        "Today",
        "retrieval",
        "info",
        ...
        "SRE",
        "query",
        "RMAN restore point-in-time procedure",
    ...
    _evt(
        ...
        "pipeline",
        "source",
        "demo-incidents-2026-Q1-postmortems",
    ...
    _evt(
        ...
        "Architect",
        "query",
        "VMware vSphere 8 best practices for banking workloads",
    ...
    _evt(
        "evt_01HX5KGH",
        "2026-05-08T10:08:44Z",
        REL_3D_AGO,
        EARLIER_THIS_WEEK,
        "auth",
        "warning",
        "external.client@partner.com",
        "external",
        "session",
    ...
    _evt(
        ...
        "DBA",
        "query",
        "Oracle PGA tuning for OLTP workload",
    ...
    },
    {
        ...
        "endpoints": [
            ...
            {"m": "POST", "p": "/login", "s": "Login"},
            {
                "m": "GET",
                "p": "/health",
                "s": "Get system health and configuration status",
            },
        ],
    },
]
...
GRAPH_ENTITIES: list[dict[str, Any]] = [
    {
        ...
        "mentions": 412,
        "sources": 47,
        "summary": "Relational database engine; primary OLTP backing store for demo workloads.",
    },
    {
        "id": "e_rman",
        "name": "RMAN",
        ...
        "mentions": 318,
        "sources": 31,
        "summary": "Oracle Recovery Manager — supported backup/restore toolchain.",
    },
    {
        "id": "e_archlog",
        "name": "Archive Log",
        ...
        "mentions": 142,
        "sources": 24,
        "summary": "Redo log archive used for PITR and standby replication.",
    },
    {
        "id": "e_rhel",
        "name": "RHEL 9",
        ...
        "mentions": 198,
        "sources": 38,
        "summary": "Red Hat Enterprise Linux 9 — certified OS for Oracle 19c+.",
    },
    {
        "id": "e_pga",
        "name": "PGA tuning",
        ...
        "mentions": 64,
        "sources": 9,
        "summary": "Program Global Area sizing for OLTP workload concurrency.",
    },
    {
        "id": "e_vmware",
        ...
        "mentions": 287,
        "sources": 22,
        "summary": "Hypervisor stack; banking-grade configuration baseline.",
    },
    {
        "id": "e_esxi",
        "name": "ESXi host",
        ...
        "mentions": 122,
        "sources": 14,
        "summary": "Bare-metal hypervisor node.",
    },
    {
        "id": "e_vmotion",
        "name": "vMotion",
        ...
        "mentions": 58,
        "sources": 9,
        "summary": "Live migration of running VMs across ESXi hosts.",
    },
    {
        "id": "e_memgraph",
        "name": "Memgraph",
        ...
        "mentions": 156,
        "sources": 19,
        "summary": "Graph DB backing LightRAG entity/relation storage.",
    },
    {
        "id": "e_mage",
        "name": "MAGE 3.8",
        ...
        "mentions": 84,
        "sources": 7,
        "summary": "Memgraph Algorithm Extensions Engine — vector_search modules.",
    },
    {
        "id": "e_cypher",
        "name": "Cypher",
        ...
        "mentions": 109,
        "sources": 12,
        "summary": "Graph query language used for pre-filter retrieval.",
    },
    {
        "id": "e_lightrag",
        "name": "LightRAG",
        ...
        "mentions": 274,
        "sources": 28,
        "summary": "Open-source retrieval framework forked into Twin KMS.",
    },
    {
        "id": "e_swift",
        "name": "SWIFT",
        ...
        "mentions": 198,
        "sources": 17,
        "summary": "Society for Worldwide Interbank Financial Telecommunication.",
    },
    {
        "id": "e_iso20022",
        "name": "ISO 20022",
        ...
        "mentions": 142,
        "sources": 14,
        "summary": "XML messaging standard for financial transactions; SWIFT migration target.",
    },
    {
        "id": "e_cft",
        "name": "CFT",
        ...
        "mentions": 92,
        "sources": 11,
        "summary": "Cross File Transfer middleware — Axway product.",
    },
    {
        "id": "e_demo_operator",
        "name": "Demo Operator",
        ...
        "mentions": 28,
        "sources": 12,
        "summary": "DBA — primary author on Oracle restart procedures.",
    },
    {
        "id": "e_demo_steward",
        "name": "Demo Steward",
        ...
        "mentions": 41,
        "sources": 18,
        "summary": "KB Admin / Tier 3 steward for the demo workspace.",
    },
    {
        "id": "e_primary_region",
        "name": "Primary demo region",
        "type": "LOCATION",
        "x": 700,
        "y": 440,
        "mentions": 37,
        "sources": 8,
        "summary": "Primary region; active site of the dual-region topology.",
    },
    {
        "id": "e_secondary_region",
        "name": "Secondary demo region",
        "type": "LOCATION",
        "x": 820,
        "y": 520,
        "mentions": 31,
        "sources": 7,
        "summary": "Secondary region; standby site.",
    },
]
