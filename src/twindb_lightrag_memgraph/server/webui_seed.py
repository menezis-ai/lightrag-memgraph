...
TAGS: list[dict[str, Any]] = [
    ...
    _tag(
        ...
        requested_by=PHILIPPE_MARCHAND,
...
ACTIVITY: list[dict[str, Any]] = [
    ...
    _evt(
        ...
        "pipeline",
        "source",
        "cib-incidents-2026-Q1-postmortems",
...
GRAPH_ENTITIES: list[dict[str, Any]] = [
    {
        ...
        "mentions": 412,
        "sources": 47,
        "summary": "Relational database engine; primary OLTP backing store for CIB workloads.",
    },
    {
        "id": "e_rman",
        "name": "RMAN",
    ...
    },
    {
        ...
        "mentions": 41,
        "sources": 18,
        "summary": "KB Admin / Tier 3 steward for CIB workspace.",
    },
    {
        "id": "e_paris",
        "name": "DC Paris",
        ...
        "mentions": 37,
        "sources": 8,
        "summary": "Primary datacenter; active site of the dual-DC topology.",
    },
    {
        "id": "e_aubervil",
        "name": "DC Aubervilliers",
        "type": "LOCATION",
        "x": 820,
        "y": 520,
        "mentions": 31,
        "sources": 7,
        "summary": "Secondary datacenter; standby site.",
    },
]
