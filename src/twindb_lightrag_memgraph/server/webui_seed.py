...
SWIFT_ISO20022_SOURCE = "swift-iso20022-migration.pdf"
REL_25M_AGO = "25m ago"
REL_30M_AGO = "30m ago"
REL_3D_AGO = "3d ago"
EARLIER_THIS_WEEK = "Earlier this week"
CLAIRE_BENOIT = "claire.benoit"
YANN_DUBOIS = "yann.dubois"
PHILIPPE_MARCHAND = "philippe.marchand"
MARC_BERTHIER = "marc.berthier"
KB_ADMIN_ROLE = "KB Admin"
...
NOTIFICATIONS: list[dict[str, Any]] = [
    {"id": "n_001", "kind": "tag-mutation", "title": "Tag", "tagname": "rman", "suffix": "applied", "sub": f"{ORACLE_RESTART_SOURCE} · 418 chunks", "rel": "12m ago", "read": False},
    {"id": "n_002", "kind": "source-failed", "title": "Ingestion failed", "sub": "huge-archive.zip · unsupported MIME", "rel": REL_30M_AGO, "read": False},
    {"id": "n_003", "kind": "source-ready", "title": "Source ready", "sub": f"{MEMGRAPH_MAGE_SOURCE} · 42 chunks", "rel": REL_25M_AGO, "read": False},
...
TAGS: list[dict[str, Any]] = [
    _tag(
        ...
        created={"by": CLAIRE_BENOIT, "at": "2025-09-12"},
        last_edit={"by": CLAIRE_BENOIT, "at": "2026-05-11", "action": "promoted to Tier 1"},
        related=[{"tag": "oracle", "strength": 0.92}, {"tag": "production", "strength": 0.71}, {"tag": "rhel9", "strength": 0.44}],
        examples=[ORACLE_RESTART_SOURCE, "/cib/runbooks/rman-restore-cookbook"],
    ),
    _tag(
        ...
        last_edit={"by": CLAIRE_BENOIT, "at": "2026-03-18", "action": "added alias ora"},
        related=[{"tag": "rman", "strength": 0.92}, {"tag": "rhel9", "strength": 0.61}, {"tag": "memgraph", "strength": 0.12}],
        examples=[ORACLE_RESTART_SOURCE, "/cib/runbooks/oracle-pga-tuning"],
    ),
    _tag(
        ...
        examples=[VMWARE_BEST_PRACTICES_SOURCE],
    ),
    _tag(
        ...
        created={"by": YANN_DUBOIS, "at": "2025-11-04"},
        last_edit={"by": YANN_DUBOIS, "at": "2026-02-10", "action": "added alias mage"},
        related=[{"tag": "graphrag", "strength": 0.81}],
        examples=[MEMGRAPH_MAGE_SOURCE],
    ),
    _tag(
        ...
        created={"by": YANN_DUBOIS, "at": "2026-01-22"},
        last_edit={"by": CLAIRE_BENOIT, "at": "2026-04-15", "action": "approved for Tier 2"},
    ...
    _tag(
        ...
        created={"by": PHILIPPE_MARCHAND, "at": "2025-12-05"},
        last_edit={"by": PHILIPPE_MARCHAND, "at": "2025-12-05", "action": "created"},
    ...
    _tag(
        ...
        last_edit={"by": CLAIRE_BENOIT, "at": "2026-05-10", "action": "tag iso20022 split out"},
        related=[{"tag": "iso20022", "strength": 0.78}, {"tag": "cft", "strength": 0.21}],
        examples=[SWIFT_ISO20022_SOURCE],
    ),
    _tag(
        ...
        created={"by": CLAIRE_BENOIT, "at": "2026-05-10"},
        last_edit={"by": CLAIRE_BENOIT, "at": "2026-05-10", "action": "created as Tier 2"},
    ...
    _tag(
        ...
        examples=[ORACLE_RESTART_SOURCE, VMWARE_BEST_PRACTICES_SOURCE],
    ),
    _tag(
    ...
    _tag(
        ...
        created={"by": CLAIRE_BENOIT, "at": "2025-10-18"},
        last_edit={"by": CLAIRE_BENOIT, "at": "2025-10-18", "action": "created"},
    ...
    _tag(
        ...
        created={"by": CLAIRE_BENOIT, "at": "2025-10-01"},
        last_edit={"by": CLAIRE_BENOIT, "at": "2025-10-01", "action": "created"},
    ...
    _tag(
        ...
        created={"by": YANN_DUBOIS, "at": "2026-02-14"},
        last_edit={"by": YANN_DUBOIS, "at": "2026-05-02", "action": "promotion requested"},
    ...
    _tag(
        ...
        created={"by": YANN_DUBOIS, "at": "2026-03-20"},
        last_edit={"by": YANN_DUBOIS, "at": "2026-03-20", "action": "created as Tier 2"},
    ),
    _tag(
        ...
        created={"by": MARC_BERTHIER, "at": "2026-04-29"},
        last_edit={"by": MARC_BERTHIER, "at": "2026-04-29", "action": "created as Tier 3"},
    ),
    _tag(
        ...
        created={"by": MARC_BERTHIER, "at": "2026-04-12"},
        last_edit={"by": MARC_BERTHIER, "at": "2026-04-12", "action": "created as Tier 3"},
    ),
    _tag(
        "argocd", "requested", "infra", "pending-review",
        "Proposed: ArgoCD — GitOps continuous-delivery controller. Awaiting Tier 3 acceptance.",
        created={"by": MARC_BERTHIER, "at": "2026-05-09"},
        last_edit={"by": MARC_BERTHIER, "at": "2026-05-09", "action": "requested"},
        related=[{"tag": "k8s", "strength": 0.7}],
        requested_by=MARC_BERTHIER, requested_at="2026-05-09",
    ...
    _tag(
        ...
        created={"by": PHILIPPE_MARCHAND, "at": "2026-05-10"},
        last_edit={"by": PHILIPPE_MARCHAND, "at": "2026-05-10", "action": "requested"},
        related=[{"tag": "iso20022", "strength": 0.85}],
        requested_by=PHILIPPE_MARCHAND, requested_at="2026-05-10",
...
ACTIVITY: list[dict[str, Any]] = [
    _evt("evt_01HX9Z7Q", "2026-05-11T09:42:18Z", "12m ago", "Today", "retrieval", "info", MARC_BERTHIER, "DBA", "query", "How to restart Oracle on RHEL 9?",
    ...
    _evt("evt_01HX9Z7M", "2026-05-11T09:35:02Z", "19m ago", "Today", "tag-mutation", "info", CLAIRE_BENOIT, KB_ADMIN_ROLE, "source", ORACLE_RESTART_SOURCE,
    ...
    _evt("evt_01HX9Z7K", "2026-05-11T09:29:51Z", REL_25M_AGO, "Today", "source-ready", "info", "system", "pipeline", "source", MEMGRAPH_MAGE_SOURCE,
    ...
    _evt("evt_01HX9Z7H", "2026-05-11T09:24:11Z", REL_30M_AGO, "Today", "source-failed", "error", CLAIRE_BENOIT, KB_ADMIN_ROLE, "source", "huge-archive.zip",
    ...
    _evt("evt_01HX9Z7B", "2026-05-11T09:11:33Z", "44m ago", "Today", "retrieval", "info", YANN_DUBOIS, "SRE", "query", "RMAN restore point-in-time procedure",
    ...
    _evt("evt_01HX9Z71", "2026-05-11T08:42:19Z", "1h ago", "Today", "source-uploaded", "info", CLAIRE_BENOIT, KB_ADMIN_ROLE, "source", SWIFT_ISO20022_SOURCE,
         "Uploaded · 14.2 MB · queued for ingestion",
         {"size_bytes": 14883941, "mime": "application/pdf", "batch_tags": ["swift", "production"]}),
    _evt("evt_01HX9Z6Y", "2026-05-11T08:30:00Z", "1h ago", "Today", "auth", "info", MARC_BERTHIER, "DBA", "session", "Bearer token issued",
    ...
    _evt("evt_01HX8VK3", "2026-05-10T17:14:08Z", "16h ago", "Yesterday", "tag-mutation", "info", CLAIRE_BENOIT, KB_ADMIN_ROLE, "bulk", "Bulk retag · 9 sources",
    ...
    _evt("evt_01HX8V2P", "2026-05-10T15:02:51Z", "18h ago", "Yesterday", "retrieval", "info", PHILIPPE_MARCHAND, "Architect", "query", "VMware vSphere 8 best practices for banking workloads",
    ...
    _evt("evt_01HX8TWA", "2026-05-10T11:48:00Z", "22h ago", "Yesterday", "settings", "info", CLAIRE_BENOIT, KB_ADMIN_ROLE, "folder", "cib · thesaurus",
         "Added new tag iso20022 (palier 2) · category messaging",
         {"tag": "iso20022", "category": "messaging", "tier": 2, "requested_by": MARC_BERTHIER}),
    ...
    _evt("evt_01HX5LM2", "2026-05-08T16:21:09Z", REL_3D_AGO, EARLIER_THIS_WEEK, "source-ready", "info", "system", "pipeline", "source", VMWARE_BEST_PRACTICES_SOURCE,
    ...
    _evt("evt_01HX5KGH", "2026-05-08T10:08:44Z", REL_3D_AGO, EARLIER_THIS_WEEK, "auth", "warning", "external.client@partner.com", "external", "session", "Login attempt rejected",
         "401 Unauthorized · IP not in allow-list · 10.214.x.x",
         {"ip": "10.214.99.4", "error_code": "E_IP_NOT_ALLOWLISTED", "attempts_24h": 7}),
    _evt("evt_01HX4XQT", "2026-05-07T14:55:18Z", "4d ago", EARLIER_THIS_WEEK, "tag-mutation", "warning", CLAIRE_BENOIT, KB_ADMIN_ROLE, "source", "rman-restore-cookbook",
    ...
    _evt("evt_01HX4WJM", "2026-05-07T11:22:01Z", "4d ago", EARLIER_THIS_WEEK, "retrieval", "info", MARC_BERTHIER, "DBA", "query", "Oracle PGA tuning for OLTP workload",
